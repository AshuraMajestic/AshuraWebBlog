...
export default function BlogDetail({ username, title, introduction, content, minutes, createdAt }) {
    return (
        <div className="container mx-auto mt-20 blog-style">
                    ...
                    <div className="grid gap-4 w-full overflow-hidden">
                        ...
                        <div className="row flex flex-row justify-between">
                            <div className="w-4/12 flex flex-row items-center">
                                ...
                                <p className="text-white ml-2 text-base">{username}</p>
                            </div>
                            ...
                            <div className="w-4/12 flex flex-row items-center justify-end">
                                <Image src={BOOK} alt="book" className="w-7 h-7" />
                                <p className="text-white ml-4 text-base">{minutes} min</p>
                            </div>
                        </div>
                        ...
                        <div className="row my-3 text-white ashura lg:ashura-xl">
